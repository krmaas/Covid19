...
# 
# countyPop$fips <- as.integer(paste0(countyPop$STATE, "0", countyPop$COUNTY))
# 
# ctyPop <- countyPop%>%
...
# 
# nytcountypop$fips <- as.character(nytcountypop$fips)
# 
...
#   theme_bw()
# 
# ### fips isn't right an a bunch of counties aren't joining.
